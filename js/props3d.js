...
const Props3 = {
  ...
  ARCH: {
    crate: (c) => [
      ...
      b('box', sh(c, 0.7), [0, 0.3, 0], [0.66, 0.08, 0.66]),
      b('box', sh(c, 0.7), [0, 0.55, 0], [0.64, 0.06, 0.64]),
    ],
    barrel: (c) => [
      b('taper', c, [0, 0.36, 0], [0.5, 0.72, 0.5]),
      b('cyl', sh(c, 0.6), [0, 0.2, 0], [0.53, 0.07, 0.53]),
      b('cyl', sh(c, 0.6), [0, 0.55, 0], [0.48, 0.07, 0.48]),
    ],
    pot: (c) => [
    ...
    sarcophagus: (c) => [
      ...
      b('sphere', sh(c, 1.25), [0, 0.68, -0.44], [0.26, 0.2, 0.26]),
    ],
    bookshelf: (c) => [
