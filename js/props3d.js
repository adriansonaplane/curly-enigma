...
const Props3 = {
  ...
  ARCH: {
    crate: (c) => [
      ...
      b('box', '#4a4a50', [0, 0.3, 0], [0.66, 0.08, 0.66]),
      b('box', '#4a4a50', [0, 0.55, 0], [0.64, 0.06, 0.64]),
    ],
    barrel: (c) => [
      b('taper', c, [0, 0.36, 0], [0.5, 0.72, 0.5]),
      b('cyl', '#484850', [0, 0.2, 0], [0.53, 0.07, 0.53]),
      b('cyl', '#484850', [0, 0.55, 0], [0.48, 0.07, 0.48]),
    ],
    pot: (c) => [
    ...
    sarcophagus: (c) => [
      ...
      b('sphere', '#8a8478', [0, 0.68, -0.44], [0.26, 0.2, 0.26]),
    ...
    bookshelf: (c) => [
      ...
      b('box', '#6a2828', [-0.2, 0.42, 0.02], [0.22, 0.42, 0.18]),
      b('box', '#2a3a5a', [0.12, 0.42, 0.02], [0.18, 0.42, 0.16]),
      b('box', '#3a5a2a', [-0.1, 0.92, 0.02], [0.24, 0.42, 0.17]),
      b('box', '#5a4a28', [0.22, 0.92, 0.02], [0.16, 0.42, 0.18]),
    ],
    weaponrack: (c) => [
