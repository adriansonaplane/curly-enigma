// ============ DIABLOID: sprites.js — screen-space portrait and icon baker ============
// Menu portraits and HUD/inventory icons are procedurally painted once into
// offscreen canvases, then blitted only into intentional 2D interface canvases.
'use strict';
...
const Sprites = {
  ...
  // World tiles, particles, fog, and ambient occlusion are owned by the
  // Three.js pipeline. This module now generates screen-space portraits and icons only.
