...
const MONSTERS = {
  ...
  // ------ Added alongside the Act asset packs (js/assetpacks.js) ------
  // Each of these has a model reserved in its act's pack, so when art lands
  // they stop being palette swaps of the shared body archetypes.
  ghoul:      { name: 'Parish Ghoul',   body: 'humanoid', pal: { main: '#8a9a6a', dark: '#4a5a32', eye: '#ff6a4f' }, hp: 26, dmg: [4, 8],  spd: 2.9, ai: 'melee',  xp: 1.1, size: 0.95 },
  ratman:     { name: 'Gutter Ratman',  body: 'humanoid', pal: { main: '#6a5a4a', dark: '#38301f', eye: '#ffd94f' }, hp: 18, dmg: [4, 7],  spd: 3.4, ai: 'melee',  xp: 1.0, size: 0.8 },
  mummy:      { name: 'Ash-Wrapped',    body: 'humanoid', pal: { main: '#c8bc9a', dark: '#7a6e52', eye: '#8ef04a' }, hp: 42, dmg: [6, 11], spd: 1.4, ai: 'melee',  elem: 'pois', xp: 1.5, size: 1.05 },
  necro:      { name: 'Bone Chanter',   body: 'humanoid', pal: { main: '#3a2a4a', dark: '#1c1226', eye: '#c07bff' }, hp: 30, dmg: [6, 11], spd: 1.8, ai: 'summoner', elem: 'arc', xp: 1.8, size: 1.0 },
  troll:      { name: 'Undercity Troll',body: 'brute',    pal: { main: '#5a7a4a', dark: '#2c3c22', eye: '#ffd94f' }, hp: 85, dmg: [11, 19], spd: 1.9, ai: 'melee',  xp: 2.0, size: 1.3 },
  ogre:       { name: 'Slag Ogre',      body: 'brute',    pal: { main: '#8a6a4a', dark: '#4a3422', eye: '#ff8a2f' }, hp: 110, dmg: [13, 22], spd: 1.6, ai: 'charger', xp: 2.2, size: 1.45 },
  lizardman:  { name: 'Fane Lizardman', body: 'humanoid', pal: { main: '#3a7a6a', dark: '#1c4038', eye: '#d0ff60' }, hp: 38, dmg: [7, 13], spd: 2.8, ai: 'melee',  elem: 'pois', xp: 1.6, size: 1.05 },
  magmagolem: { name: 'Magma Golem',    body: 'brute',    pal: { main: '#7a2a12', dark: '#3a1206', eye: '#ffb04f' }, hp: 190, dmg: [16, 27], spd: 1.3, ai: 'melee',  elem: 'fire', xp: 2.6, size: 1.5 },
  cyclops:    { name: 'Throne Cyclops', body: 'brute',    pal: { main: '#6a5a6a', dark: '#332a36', eye: '#ff4f4f' }, hp: 150, dmg: [15, 25], spd: 2.0, ai: 'charger', xp: 2.5, size: 1.5 },
  ettin:      { name: 'Ettin Warlord',  body: 'brute',    pal: { main: '#5a4a3a', dark: '#2a221a', eye: '#ffe94f' }, hp: 170, dmg: [14, 24], spd: 1.8, ai: 'melee',  xp: 2.5, size: 1.55 },
...
const ACTS = [
  ...
  { name: 'The Burning Throne',   theme: 'hell',     boss: 'maltherion',
    pool: ['knight', 'brute', 'imp', 'succubus', 'cultist', 'golem', 'lich', 'magmagolem', 'cyclops', 'ettin'], mlvl: 38,
...
const ABYSS = { name: 'The Endless Abyss', themes: ['crypt', 'catacomb', 'cavern', 'fane', 'hell'],
  pool: ['zombie', 'skeleton', 'skelarcher', 'spider', 'shaman', 'wraith', 'goatman', 'imp', 'golem', 'exploder', 'cultist', 'succubus', 'knight', 'brute', 'serpent', 'lich',
         'ghoul', 'ratman', 'mummy', 'necro', 'troll', 'ogre', 'lizardman', 'magmagolem', 'cyclops', 'ettin'],
  mlvl0: 48 };
...
const THEMES = {
  town:     { floor: '#4a4a3c', floorAlt: '#5e5e4a', wall: '#6a5a44', wallTop: '#9a8a68', ambient: 0.34, torch: '#ffb04f', name: 'Haven\'s Rest',
              pattern: 'cobble', fog: ['#c8a868', 0.045], grade: ['#28384c', '#c8843c', 0.18], shaft: null, amb: 'firefly', water: '#38648a', moss: '#5a7040' },
  crypt:    { floor: '#38404c', floorAlt: '#2a2e38', wall: '#222830', wallTop: '#6a7488', ambient: 0.82, torch: '#ffb04f', hazards: ['spikes', 'water'],
              props: ['pillar', 'grave', 'bones', 'statue', 'cobweb', 'rubble', 'candles', 'crate', 'sarcophagus', 'bookshelf', 'chandelier', 'weaponrack', 'table', 'chair', 'sack', 'pot', 'lantern', 'wellhead',
                       'soul_cage', 'reliquary', 'grave_marker', 'corpse_shroud', 'prison_cell'],
              fixtures: ['lever', 'bookshelf', 'fountain'], doors: ['arch', 'wood', 'barred'],
              pattern: 'slab', fog: ['#8ca4c0', 0.09], grade: ['#16243e', '#0a1018', 0.26], shaft: '#a8c8f0', amb: 'dust', water: '#28455c', moss: '#3e5548' },
  catacomb: { floor: '#4a4030', floorAlt: '#342c20', wall: '#2a2014', wallTop: '#6a5840', ambient: 0.84, torch: '#ff9a3f', hazards: ['spikes', 'gas'],
              props: ['pillar', 'bones', 'urn', 'skullpile', 'cobweb', 'banner', 'rubble', 'crate', 'sarcophagus', 'bookshelf', 'candles', 'pot', 'sack', 'table', 'lantern', 'anvil',
                       'ritual_circle', 'spider_eggsac', 'plague_vat', 'haunted_doll'],
              fixtures: ['lever', 'bookshelf', 'brazier_unlit'], doors: ['wood', 'barred', 'arch'],
              pattern: 'brick', fog: ['#a89468', 0.08], grade: ['#382a12', '#120a04', 0.24], shaft: '#e8c88a', amb: 'dust', water: null, moss: '#564a2c' },
  cavern:   { floor: '#38281c', floorAlt: '#241a12', wall: '#1e1208', wallTop: '#56422e', ambient: 0.86, torch: '#ff6a2f', hazards: ['lava', 'vent'],
              props: ['rock', 'crystal', 'stalagmite', 'mushroom', 'orevein', 'crate', 'rubble', 'bones', 'pot', 'cauldron', 'anvil', 'sack',
                       'stalactite', 'echo_crystal', 'mining_beam', 'dynamite', 'ogre_bonepile'],
              fixtures: ['orevein', 'lever', 'brazier_unlit'],
              pattern: 'rough', fog: ['#c06438', 0.06], grade: ['#4a1c08', '#160400', 0.28], shaft: null, amb: 'ember', water: null, moss: '#6a3c1e' },
  fane:     { floor: '#283830', floorAlt: '#1c2a22', wall: '#141e18', wallTop: '#4a6454', ambient: 0.85, torch: '#5affc8', hazards: ['gas', 'spikes', 'water', 'spore'],
  ...
  hell:     { floor: '#3e221c', floorAlt: '#281210', wall: '#200c08', wallTop: '#5c3828', ambient: 0.87, torch: '#ff4f2f', hazards: ['lava', 'spikes', 'ember'],
              ...
              pattern: 'cracked', fog: ['#a83428', 0.09], grade: ['#581408', '#1a0000', 0.32], shaft: '#ff8a50', amb: 'ash', water: null, moss: '#742818' },
};
