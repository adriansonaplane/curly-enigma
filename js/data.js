...
const THEMES = {
  ...
  fane:     { floor: '#26362e', floorAlt: '#203028', wall: '#182420', wallTop: '#32463c', ambient: 0.85, torch: '#5affc8', hazards: ['gas', 'spikes', 'water', 'spore'],
  ...
  hell:     { floor: '#38201c', floorAlt: '#301a16', wall: '#24100c', wallTop: '#4c2c24', ambient: 0.87, torch: '#ff4f2f', hazards: ['lava', 'spikes', 'ember'],
